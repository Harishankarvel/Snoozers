        ...
        try:
            while True:
                ...
                ego_dynamics = {
                    ...
                    "lateral_g": round(manager.lateral_offset * 0.15, 3)
                }
                ...
                # 3. Run Decision Engine with Confidence Arbitration
                ...
                packet = {
                    ...
                    "decision": {
                        ...
                        "reasoning": reasoning,
                        "primaryReason": reasoning.get(action, result.get("justification", "Nominal autonomous cruising along safety envelope.")),
