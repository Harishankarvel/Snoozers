    ...
    <section className="bg-[#080D17]/90 backdrop-blur-md rounded-xl border border-[#1A2638] p-4 flex flex-col gap-3 shadow-lg">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-2.5">
        ...
        <button
          ...
          className={`flex flex-col items-center justify-center p-3 rounded-lg border text-center transition-all active:scale-95 ${
        ...
        >
          ...
          <span className="text-xs font-mono font-bold">Cut-In Vehicle</span>
          <span className="text-[10px] font-mono text-slate-500 mt-0.5">TTC &lt; 2.0s</span>
        </button>
        ...
        >
          <UserX className="w-5 h-5 text-rose-400 mb-1.5" />
          <span className="text-xs font-mono font-bold">Jaywalking</span>
          <span className="text-[10px] font-mono text-slate-500 mt-0.5">Blind Crosswalk</span>
        </button>

        {/* 3. Sudden Lead Braking */}
        <button
          id="btn-fault-brake"
        ...
        >
          ...
          <span className="text-xs font-mono font-bold">Hard Brake</span>
          <span className="text-[10px] font-mono text-slate-500 mt-0.5">-8.5 m/s² Decel</span>
        </button>
        ...
        >
          <CloudRain className="w-5 h-5 text-cyan-400 mb-1.5" />
          <span className="text-xs font-mono font-bold">Weather Degrade</span>
          <span className="text-[10px] font-mono text-slate-500 mt-0.5">Heavy Rain/Fog</span>
        </button>
        ...
        >
          <EyeOff className="w-5 h-5 text-purple-400 mb-1.5" />
          <span className="text-xs font-mono font-bold">Blindspot Fault</span>
          <span className="text-[10px] font-mono text-slate-500 mt-0.5">LiDAR/Cam Noise</span>
        </button>

        {/* 6. Reset / Clear All Faults */}
        <button
          id="btn-fault-reset"
          onClick={() => {
          ...
          className="flex flex-col items-center justify-center p-3 rounded-lg border border-[#1A2638] bg-[#0A101D] text-slate-300 hover:border-emerald-500/50 hover:text-emerald-300 hover:bg-[#0E1626] text-center transition-all active:scale-95"
        >
          <RotateCcw className="w-5 h-5 text-emerald-400 mb-1.5" />
          <span className="text-xs font-mono font-bold">Reset Nominal</span>
          <span className="text-[10px] font-mono text-slate-500 mt-0.5">Clear Active Injections</span>
        </button>
      </div>
